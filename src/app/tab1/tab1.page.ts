...
export class Tab1Page {
  ...
  async sendToWhatsapp() {
    ...
    window.open(
      `https://api.whatsapp.com/send?phone=6285171003608&text=${output}`,
      '_blank'
    );
  ...
  async sendToTelegram() {
    ...
    window.open(`https://t.me/Sit1701?start=${output}`, '_blank');
  }
  ...
  async sendToEmail() {
    ...
    const url = `mailto:bintangadhiyaksa03@gmail.com?subject=Data&20Informasi&body=${output}`;
